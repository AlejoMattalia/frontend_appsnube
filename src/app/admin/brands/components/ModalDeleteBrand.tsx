...
export function ModalDeleteBrand({ name, id }: { name: string, id: number }) {
    ...
    const deleteBrand = async () => {
        try {
            const res = await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}api/brand/delete_brand/${id}`, {
                headers: {
                    Authorization: `${token}`
                }
            });
